...
fig_hist_week <- preds_week |> 
  ...
  ggplot(data = _, aes(x = prob)) + 
   geom_histogram(bins = 15, fill = "red", col = "black", alpha = .4) +
...
fig_hist_week +
  geom_vline(xintercept = .5, color = "orange", size = 2)
```
:::
...
<!--NEED TO ADD LAPSE RATES  - 25.4, 7.7, .4-->
...
fig_hist_day +
  geom_vline(xintercept = .9, color = "orange", size = 2)
```
:::
