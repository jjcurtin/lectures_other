...
<!--GEF: FIX so these statements aren't repetitive-->
...
Fortunately, I am here today to tell you that digital therapeutics, and in particular, digital therapeutics **delivered on smartphones and made smarter still by personal sensing technologies**, are now emerging to target these very same three issues.  <!--GEF: the opening of this sentence reads weird to me. I think it makes it sound like the fortunate part is that you're here rather than the content. Maybe simplify to "fortunately, digital therapeutics..." -->
...
<!--GEF: I'm glad you put this back in, and I like its placement and emphasis. -->
...
For example, patients using digital therapeutics have about double the odds <!--GEF: "are about/almost twice as likely" feels more accessible than double the odds -->of remaining abstinent from alcohol or other drugs.

<!--GEF: simplify next two paragraphs to: "These increases in abstinence are observed not only when compared to patients on waitlists, who have not yet gained access to treatment, but also when digital therapeutics are added on top of traditional treatments for substance use disorders." avoids repeating the same wordy opening clause -->
...
/beta.png
<!--GEF: this whole introduction over the next few paragraphs is really improved. It is so much clearer and more accessible, and it just feels more comfortable/natural. -->
OK, so let's call the apps I have described to you so far, the beta version <!--GEF: love "beta version" -->of digital therapeutics.  Their power arises from easy, 24/7 access to their rich and diverse set of interventions, tools, and services.
...
<!--GEF: these are amazing, I laughed out loud at that last sentence. -->
...
If he had also received traditional mental healthcare, he might have given permission for the app share his risk with his therapist.  This could allow clinicians to efficiently direct their own limited resources toward their patients with greatest need. <!--GEF: consider staying with your dad here rather than zooming back out fully to other patients. Maybe: "His clinician could give my dad more support during those harder winter months, and perhaps allocate their resources to other, more critical patients when my dad has his friend around." -->
